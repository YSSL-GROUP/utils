(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.rsUtils = {}));
  ...
  function ellipsis() {
    ...
    dom.style.overflow = "hidden"; // @ts-ignore
    ...
    if (row === 1) {
      ...
      dom.style["display"] = "-webkit-box"; // @ts-ignore

      dom.style["-webkit-line-clamp"] = row; // @ts-ignore
  ...
  exports.downloadViaBlob = downloadViaBlob;
  exports.downloadViaUrl = downloadViaUrl;
  exports.ellipsis = ellipsis;
  exports.encryptPhone = encryptPhone;
  exports.extendSerialNumber = extendSerialNumber;
