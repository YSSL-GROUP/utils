(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rsUtils = factory(global.React));
  ...
  function calculatePercentage(dividend, divisor, outliers) {
    var several = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 2;

    if (dividend === null || divisor === null) {
      return outliers !== null && outliers !== void 0 ? outliers : OUTLIERS;
    }
  ...
  function encryptPhone(phone, outliers) {
    if (!phone) return outliers !== null && outliers !== void 0 ? outliers : OUTLIERS;
