(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@/const'), require('react')) :
  typeof define === 'function' && define.amd ? define(['@/const', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rsUtils = factory(global._const, global.React));
}(this, (function (_const, React) { 'use strict';
  ...
  function calculatePercentage(dividend, divisor) {
    ...
    var outliers = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _const.OUTLIERS;
  ...
  function encryptPhone(phone) {
    var outliers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _const.OUTLIERS;
  ...
  function ellipsis(el) {
    return React__default['default'].cloneElement(el, {
