 ...
 * ```
 */
declare function calculatePercentage<O = string>(dividend: number | string | null, divisor: number | string | null, outliers?: O, several?: number): string | NonNullable<O> | undefined;
 ...
 * ```
 */
declare function encryptPhone<O = string>(phone: string | number | null, outliers?: O): string | NonNullable<O>;
